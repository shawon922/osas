...
<tr>
    ...
    <td>
        <?php echo $this->Form->input('OfferCourseChild.'.$i.'.batch', array('type' => 'select', 'label' => false, 'class' => 'select2', 'multiple' => true, 'data-placeholder' => '--Select Batch--', 'options' => $batch, 'style' => 'min-width: 230px;')); ?>
    </td>
    <td>
