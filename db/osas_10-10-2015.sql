...
--
-- Host: localhost
-- Generation Time: Oct 10, 2015 at 04:36 AM
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `modified` int(11) NOT NULL,
  `terminal` varchar(20) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='User information table';
...
(1, 0, 0, 0, 0, 'Md Mahfuzur', 'Rahman', '01928172957', 'Khilkhet, Dhaka', 'admin', 'shawon922@gmail.com', '4fabdf02e0d9dc342c107698a52c9029dd5904ec', 1, 0, 0, 0, 0, '::1'),
