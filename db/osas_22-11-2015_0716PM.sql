...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2015 at 07:15 PM
...
`id` int(11) NOT NULL,
  ...
  `modified` int(11) NOT NULL,
  `terminal` varchar(20) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Student information table';

--
-- Dumping data for table `students`
--

INSERT INTO `students` (`id`, `department_id`, `id_no`, `batch`, `first_name`, `last_name`, `gender`, `date_of_birth`, `date_of_admission`, `contact_no`, `address`, `email`, `status`, `created_by`, `modified_by`, `created`, `modified`, `terminal`) VALUES
(1, 0, '443443', '36', 'dfgfg', 'fgfgg', 1, 1448301600, 1448215200, '334567890', 'ggfgggg', 'dfdfd@gmaillc.com', 1, 0, 0, 1448114347, 1448114347, '::1'),
(2, 1, '1234567891', '36', 'dfsdfsdfds', 'sdfdsfds', 1, 633636000, 1288548000, '12345678922', 'rhfgfgfgdfgdfgdf', 'dfdfdddd@gmaillc.com', 1, 0, 0, 1448115010, 1448115010, '::1'),
(3, 1, '45345345345', '36', 'fgdfgdfgdfg', 'dfgdfgdfg', 1, 631130400, 1420048800, '34344343443', 'fvvdddgdgsfsfdgdg', 'jlkjlkjlkj@gmai.lcom', 1, 0, 0, 1448115186, 1448115186, '::1');
...
`id` int(11) NOT NULL,
  ...
  `modified` int(11) NOT NULL,
  `terminal` varchar(20) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='User information table';
...
(8, 3, 0, 0, 2, 0, 'dfsdfsdfds', 'sdfdsfds', '12345678922', 'rhfgfgfgdfgdfgdf', '1234567891', 'dfdfdddd@gmaillc.com', 'bab872616134b1fa8cd82499d40e3bb4c2bed2d8', 1, 0, 0, 1448115010, 1448115010, '::1'),
(9, 3, 1, 0, 3, 0, 'fgdfgdfgdfg', 'dfgdfgdfg', '34344343443', 'fvvdddgdgsfsfdgdg', '45345345345', 'jlkjlkjlkj@gmai.lcom', 'a0561b2b121bec4ebf222b7b28302a689a0820c4', 1, 0, 0, 1448115186, 1448115186, '::1');
